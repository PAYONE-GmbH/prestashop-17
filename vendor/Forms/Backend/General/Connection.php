        ...
        return array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'headline' => $this->translate('FC_PAYONE_BACKEND_CONNECTION_POV_PORTALID_HEADLINE'),
                        'col' => 3,
                        'type' => 'text',
                        'hint' => $this->translate('FC_PAYONE_BACKEND_CONNECTION_POV_PORTALID_DESC'),
                        'name' => 'FC_PAYONE_CONNECTION_POV_PORTALID',
                        'label' => $this->translate('FC_PAYONE_BACKEND_CONNECTION_POV_PORTALID'),
                    ),
                    array(
                        'col' => 3,
                        'type' => 'text',
                        'hint' => $this->translate('FC_PAYONE_BACKEND_CONNECTION_POV_PORTALKEY_DESC'),
                        'name' => 'FC_PAYONE_CONNECTION_POV_PORTALKEY',
                        'label' => $this->translate('FC_PAYONE_BACKEND_CONNECTION_POV_PORTALKEY'),
                    ),
                ),
