    ...
    <fieldset>
        ...
        <div class="col-xs-6">
            <div class="form-group row">
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <select name="fcpayone_form[days]" id="days" class="form-control form-control-select">
                            <option value="">-</option>
                    ...
                    <div class="col-xs-4">
                        <select id="months" name="fcpayone_form[months]" class="form-control form-control-select">
                            <option value="">-</option>
                    ...
                    <div class="col-xs-4">
                        <select id="years" name="fcpayone_form[years]" class="form-control form-control-select">
                            <option value="">-</option>
